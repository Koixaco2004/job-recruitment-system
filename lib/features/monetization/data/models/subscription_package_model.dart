...
class SubscriptionPackageModel extends SubscriptionPackageEntity {
  ...
  factory SubscriptionPackageModel.fromJson(Map<String, dynamic> json) {
    return SubscriptionPackageModel(
      ...
      maxActiveJobs: json['maxActiveJobs'] as int? ?? 0,
      jobDurationDays: json['jobDurationDays'] as int? ?? 0,
      maxProfileViewsPerJob: json['maxProfileViewsPerJob'] as int? ?? 0,
      dailyApplicationProcessLimit: json['dailyApplicationProcessLimit'] as int? ?? 0,
      bumpPostQuota: json['bumpPostQuota'] as int? ?? 0,
      maxScreeningQuestions: json['maxScreeningQuestions'] as int? ?? 0,
      monthlyHeadhuntProfileViews: json['monthlyHeadhuntProfileViews'] as int? ?? 0,
      monthlyFreeProceeds: json['monthlyFreeProceeds'] as int? ?? 0,
